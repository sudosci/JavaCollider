...
public abstract class JavaCollider {
	...
	/**
	 * <code>true</code> if we're running on Mac OS X. This value can be used to
	 * check if certain UGens are available, or to find the location of scsynth.
	 */
	...
	/**
	 * This method gets called when one tries to start the .jar file directly. It
	 * prints copyright information and quits, unless one of the test methods is
	 * specified in the arguments
	 *
	 * @param args
	 *            shell arguments. there may be a single argument
	 *            &quot;--test1&quot; or &quot;--test2&quot; to run the demos.
	 *            &quot;--bindefs&quot; to create a binary def file from the xml
	 *            descriptions
	 */
	...
	/**
	 * Set a font for a container and all children we can find in this container
	 * (calling this method recursively). This is necessary because calling
	 * <code>setFont</code> on a <code>JPanel</code> does not cause the
	 * <code>Font</code> of the gadgets contained in the panel to change their
	 * fonts.
	 *
	 * @param c
	 *            the container to traverse for children whose font is to be changed
	 * @param fnt
