...
//	}
	...
	public OSCMessage setMsg(int ctrlIdx, float value) {
		return new OSCMessage("/n_set",
				new Object[] { new Integer(getNodeID()), new Integer(ctrlIdx), new Float(value) });
	}
	...
	public OSCMessage mapMsg(String ctrlName, Bus bus) {
		return (new OSCMessage("/n_map",
				new Object[] { new Integer(getNodeID()), ctrlName, new Integer(bus == null ? -1 : bus.getIndex()) }));
	}
