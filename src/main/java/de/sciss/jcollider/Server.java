...
//		trns.send( bndl );
	...
	public OSCMessage sendMsgSync(OSCMessage msg, String doneCmd, String failCmd, int[] doneArgIndices,
		...
		} catch (InterruptedException e1) { /* ignored */ } finally {
			resp.remove();
		}
...
//System.err.println( "...succeeded" );
							cStarted = true;
							if (startAliveThread)
								server.startAliveThread(2.0f, 0.7f, 8); // allow really long unresponsiveness as a real server quit is recognized instantly
						}
