...
/**
 * A number space describes a field of possible numeric values with a minimum
 * and maximum (which can be infinity), a central value (usually zero) a
 * quantization size which can be used to describe integers or to limit the
 * numeric resolution.
 *
...
public class NumberSpace {
	 ...
	 */
	public static NumberSpace genericDoubleSpace = new NumberSpace(Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY,
			0.0);
	/**
	 * Ready-made NumberField for integer values, without boundaries.
	 */
	public static NumberSpace genericIntSpace = new NumberSpace(Integer.MIN_VALUE, Integer.MAX_VALUE, 1.0);

	private final boolean isInteger;

	/**
	 * Creates a new <code>NumberSpace</code> with the given values.
	 *
	 * @param min
	 *            minimum allowed value or a special value like
	 *            Double.NEGATIVE_INFINITY or Integer.MIN_VALUE
	 * @param max
	 *            maximum allowed value or a special value like
	 *            Float.POSITIVE_INFINITY or Long.MAX_VALUE
	 * @param quant
	 ...
	 * @param reset
	 *            central value for initializations of unknown values. Usually zero.
	 */
	...
	/**
	 * Creates a new NumberSpace with the given values. Reset is zero or on of
	 * min/max, increment is max( 1, quant )
	 */
	 ...
	 *
	 * @return true if the quantization is integer and hence all valid values are
	 *         integers
	 */
	...
	/**
	 * Utility method for creating a generic integer space for a given minimum and
	 * maximum value. Quant will be set to 1.0.
	 */
	...
	/**
	 * Validates a value for this number space. First, it is quantized (rounded) if
	 * necessary. Then it is limited to the minimum and maximum value.
	 *
	 * @param value
	 *            a value to validate
	 * @return the input value possibly quantisized and limited the space's bounds.
	 */
	...
	/**
	 * Validates a value for an ad-hoc number space. First, it is quantized
	 * (rounded) if necessary. Then it is limited to the minimum and maximum value.
	 *
	 * @param value
	 *            a value to validate
	 * @param min
	 ...
	 * @return the input value possibly quantisized and limited the described
	 *         space's bounds.
	 */
