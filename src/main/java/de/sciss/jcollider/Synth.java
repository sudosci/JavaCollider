...
public class Synth extends Node {
	...
	public float get(int index) throws IOException {
		...
		final OSCMessage replyMsg = getServer().sendMsgSync(getMsg, "/n_set", "/fail", new int[] { 0, 1 },
				new Object[] { new Integer(getNodeID()), new Integer(index) }, new int[] { 0 },
				new Object[] { getMsg.getName() }, 4f);
	...
	public float[] get(int[] indices) throws IOException {
		...
		final OSCMessage replyMsg = getServer().sendMsgSync(getMsg, "/n_set", "/fail", doneIndices, doneMatches,
	...
	public float get(String name) throws IOException {
		...
		final OSCMessage replyMsg = getServer().sendMsgSync(getMsg, "/n_set", "/fail", new int[] { 0, 1 },
				new Object[] { new Integer(getNodeID()), name }, new int[] { 0 }, new Object[] { getMsg.getName() },
				4f);
	...
	public float[] getn(int index, int count) throws IOException {
		...
		final OSCMessage replyMsg = getServer().sendMsgSync(getnMsg, "/n_setn", "/fail", new int[] { 0, 1, 2 },
				new Object[] { new Integer(getNodeID()), new Integer(index), new Integer(count) }, new int[] { 0 },
				new Object[] { getnMsg.getName() }, 4f);
	...
	public float[] getn(String name, int count) throws IOException {
		...
		final OSCMessage replyMsg = getServer().sendMsgSync(getnMsg, "/n_setn", "/fail", new int[] { 0, 1, 2 },
				new Object[] { new Integer(getNodeID()), new Integer(name), new Integer(count) }, new int[] { 0 },
				new Object[] { getnMsg.getName() }, 4f);
	...
	public float[] getn(int[] indices, int[] counts) throws IOException {
		...
		final OSCMessage replyMsg = getServer().sendMsgSync(getnMsg, "/n_setn", "/fail", doneIndices, doneMatches,
	...
	public OSCMessage getnMsg(int index, int count) {
		return new OSCMessage("/s_getn",
				new Object[] { new Integer(getNodeID()), new Integer(index), new Integer(count) });
	}
	...
	public OSCMessage getnMsg(String name, int count) {
		return new OSCMessage("/s_getn", new Object[] { new Integer(getNodeID()), name, new Integer(count) });
	}
